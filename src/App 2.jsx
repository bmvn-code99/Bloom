...
export default function BloomV5() {
  ...
  var _er = useState(false); var editingRoots = _er[0]; var setEditingRoots = _er[1];
  var _erb = useState(""); var rootsEditBRL = _erb[0]; var setRootsEditBRL = _erb[1];
  var _erg = useState(""); var rootsEditGBP = _erg[0]; var setRootsEditGBP = _erg[1];
  ...
  var __rt = useState(_sd.roots !== undefined ? _sd.roots : 0); var ROOTS = __rt[0]; var setRoots = __rt[1];
  var __rtg = useState(_sd.rootsG !== undefined ? _sd.rootsG : 0); var ROOTSG = __rtg[0]; var setRootsG = __rtg[1];
  ...
  // ─── AI Chat ─────────────────────────────────────────────────
  // ── Tool definitions for AI editor ──────────────────────────
  ...
  if (screen === "login") {
    return (
      <div style={{minHeight:"100vh",background:GRAD,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:F2,padding:24}}>
        <style>{CSS}</style>
        <div style={{width:200,height:200,borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 24px rgba(201,168,76,0.1)",marginBottom:24,background:"rgba(201,168,76,0.04)"}}><img src="https://res.cloudinary.com/dhjsldh2q/image/upload/v1772914730/bloom_logo.png" style={{width:200,height:200,objectFit:"contain",borderRadius:"50%"}} /></div>
  ...
  return (
    <div style={{minHeight:"100vh",background:"#F5F0E8",fontFamily:F2,color:"#2C2C2C",paddingBottom:100,overflowX:"hidden"}}>
      ...
      <div style={{background:GRAD,padding:"20px 20px 24px",textAlign:"center",width:"100%"}}>
        ...
        <div style={{width:200,height:200,borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 20px rgba(201,168,76,0.08)",margin:"0 auto 12px",background:"rgba(201,168,76,0.04)"}}><img src="https://res.cloudinary.com/dhjsldh2q/image/upload/v1772914730/bloom_logo.png" style={{width:200,height:200,objectFit:"contain",borderRadius:"50%"}} /></div>
              ...
              <div>
                ...
                <div style={{display:"flex",justifyContent:"center",marginBottom:4}}>
                  {donut([{v:BRUT,c:"#27AE60"},{v:NATT,c:"#3498DB"},{v:Math.max(0,TP1-PD1),c:"#E67E22"},{v:RM2,c:"#C0392B"}], 200, 18,
                    <div style={{width:136,height:136,minWidth:136,minHeight:136,borderRadius:"50%",display:"inline-flex",alignItems:"center",justifyContent:"center",background:"rgba(201,168,76,0.04)"}}><img src="https://res.cloudinary.com/dhjsldh2q/image/upload/v1772914729/bloom_overview.png" style={{width:136,height:136,objectFit:"contain",borderRadius:"50%"}} /></div>
                  )}
                </div>
                ...
                <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:36}}>
                  ...
                  <div style={{flexShrink:0}}>
                    {donut([{v:BRUT,c:"#27AE60"},{v:NATT,c:"#3498DB"},{v:Math.max(0,TP1-PD1),c:"#E67E22"},{v:RM2,c:"#C0392B"}], 260, 24,
                      <div style={{width:200,height:200,minWidth:200,minHeight:200,borderRadius:"50%",display:"inline-flex",alignItems:"center",justifyContent:"center",background:"rgba(201,168,76,0.04)"}}><img src="https://res.cloudinary.com/dhjsldh2q/image/upload/v1772914729/bloom_overview.png" style={{width:200,height:200,objectFit:"contain",borderRadius:"50%"}} /></div>
                    )}
                  </div>
                  <div style={{flex:1,textAlign:"center",minWidth:0}}>
                    <div style={{fontSize:9,letterSpacing:2,textTransform:"uppercase",color:"rgba(232,208,138,0.5)",marginBottom:4}}>{tr("phase2")}</div>
          ...
          {[
            ...
            return (
              <button key={i} onClick={ph.fn} style={{background:ph.on?"#fff":"#FDFAF4",border:ph.on?"2px solid rgba(128,66,24,0.12)":"1px solid rgba(128,66,24,0.08)",borderRadius:18,padding:"20px 18px",cursor:"pointer",textAlign:"center",fontFamily:F2,transition:"all 0.25s",boxShadow:ph.on?"0 8px 32px rgba(98,48,15,0.08)":"none"}}>
                ...
                <div style={{width:isMobile?110:200,height:isMobile?110:200,borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 10px",background:"rgba(201,168,76,0.04)"}}><img src={ph.logo} style={{width:isMobile?110:200,height:isMobile?110:200,objectFit:"contain",borderRadius:"50%"}} /></div>
                ...
                <div style={{background:"#FBF7F0",padding:"16px",display:"flex",flexDirection:"column",gap:10}}>
                  ...
                  <div style={{background:"#fff",borderRadius:14,border:"1px solid rgba(98,48,15,0.08)",overflow:"hidden"}}>
                    <div onClick={function(){setP1StgOpen(p1StgOpen==="s0"?null:"s0");}} style={{padding:"14px 18px",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                      ...
                      <div style={{display:"flex",alignItems:"center",gap:10}}>
                        {isA && !editingRoots && <button onClick={function(e){e.stopPropagation();setRootsEditBRL(String(ROOTS));setRootsEditGBP(String(ROOTSG));setEditingRoots(true);}} style={{fontSize:10,color:"#27AE60",background:"rgba(39,174,96,0.08)",border:"1px solid rgba(39,174,96,0.2)",borderRadius:6,padding:"3px 8px",cursor:"pointer",fontFamily:F2}}>Edit</button>}
                        <div style={{textAlign:"right"}}>
                    ...
                    {p1StgOpen === "s0" && (
                      <div style={{padding:"0 14px 14px",animation:"fadeUp 0.2s ease"}}>
                        {editingRoots && isA && <div style={{background:"rgba(39,174,96,0.06)",borderRadius:12,padding:"16px",marginBottom:12,border:"1px solid rgba(39,174,96,0.2)"}}>
                          <div style={{fontSize:11,color:"#27AE60",fontWeight:600,marginBottom:12,letterSpacing:1,textTransform:"uppercase"}}>Edit Foundation Equity</div>
                          <div style={{display:"flex",flexDirection:"column",gap:10}}>
                            <div><div style={{fontSize:10,color:"#9A9A9A",marginBottom:4}}>Value in BRL (R$)</div><input type="number" value={rootsEditBRL} onChange={function(e){setRootsEditBRL(e.target.value);}} style={{width:"100%",padding:"8px 12px",borderRadius:8,border:"1px solid rgba(39,174,96,0.3)",fontSize:13,fontFamily:F2,outline:"none",boxSizing:"border-box"}} /></div>
                            <div><div style={{fontSize:10,color:"#9A9A9A",marginBottom:4}}>Value in GBP (£)</div><input type="number" value={rootsEditGBP} onChange={function(e){setRootsEditGBP(e.target.value);}} style={{width:"100%",padding:"8px 12px",borderRadius:8,border:"1px solid rgba(39,174,96,0.3)",fontSize:13,fontFamily:F2,outline:"none",boxSizing:"border-box"}} /></div>
                          </div>
                          <div style={{display:"flex",gap:8,marginTop:12}}>
                            <button onClick={function(){
                              var nb=parseFloat(rootsEditBRL)||0; var ng=parseFloat(rootsEditGBP)||0;
                              setRoots(nb); setRootsG(ng);
                              _saveLS({roots:nb, rootsG:ng});
                              setEditingRoots(false);
                              setToast(tr("saved"));
                            }} style={{flex:1,padding:"8px",borderRadius:8,border:"none",background:"linear-gradient(135deg,#27AE60,#2ECC71)",color:"#fff",fontSize:11,fontWeight:600,cursor:"pointer"}}>Save</button>
                            <button onClick={function(){setEditingRoots(false);}} style={{flex:1,padding:"8px",borderRadius:8,border:"1px solid rgba(39,174,96,0.2)",background:"transparent",color:"#9A9A9A",fontSize:11,cursor:"pointer"}}>Cancel</button>
                          </div>
                        </div>}
